...
```{r}
e_split <- evaluationScheme(m_user_item_r1,method="split",train = 0.8,k=1,given =-1)
```

## Trainiere ein IBCF Modell mit 30 Nachbarn und Cosine Similarity
```{r}
IBCF <- Recommender(getData(e_split, "train"), "IBCF",
                        param=list(normalize = NULL ,method="cosine"))
```

## Bestimme die Verteilung der Filme, welche bei IBCF für paarweise Ähnlichkeitsvergleiche verwendet werden
```{r}
p <- predict(IBCF, getData(e_split, "unknown"), type="topNList", n=30)
```
